...
{
       0,   127,   127,   133,   139,   145,   153,   154,   160,   164,
     165,   166,   204,   205,   206,   212,   218,   222,   225,   226,
     227
};
#endif
...
{
  "$end", "error", "$undefined", "DT", "IF", "THEN", "ELSE", "ENDIF",
  "ID", "ARITHOP", "RELOP", "LOGOP", "STRCONST", "NUMCONST", "CHARCONST",
  "'!'", "'('", "')'", "';'", "'='", "$accept", "Program", "Lines", "Line",
  "Expr", "Decl", "Assign", YY_NULLPTR
};
#endif
...
static const yytype_int16 yytoknum[] =
{
     ...
     265,   266,   267,   268,   269,    33,    40,    41,    59,    61
};
# endif
...
{
      -1,     0,    -7,     8,    -9,    35,    19,    -9,    -1,    -5,
      18,    -9,     8,    -9,    35,    27,    -9,    -9,    -9,    10,
      35,    35,    -9,    -9,    21,    -9,    -9,    11,    35,    -9,
      28,    24,    39,    11,    -1,    40,    -1,    38,    -9
};
...
{
       0,     0,     0,    14,    15,     0,     0,     2,     4,     0,
       0,     9,     0,    17,     0,     0,    16,     1,     3,     0,
       0,     0,     7,     8,     0,    19,    18,    20,     0,    11,
      12,    13,     0,    10,     0,     6,     0,     0,     5
};
...
{
      18,    16,     1,     2,    19,    20,    21,     3,    12,    14,
      24,    27,     4,    22,     5,    29,    30,    31,     3,    17,
      19,    20,    21,     4,    33,     5,    35,    15,    37,    28,
      19,    20,    21,    19,    20,     3,    23,    19,    32,    25,
       4,    26,     5,     3,    34,    38,    36,    13,     4,     0,
       5
};

static const yytype_int8 yycheck[] =
{
       8,     5,     3,     4,     9,    10,    11,     8,     8,    16,
      14,    15,    13,    18,    15,    19,    20,    21,     8,     0,
       9,    10,    11,    13,    28,    15,    34,    19,    36,    19,
       9,    10,    11,     9,    10,     8,    18,     9,    17,    12,
      13,    14,    15,     8,     5,     7,     6,     1,    13,    -1,
      15
};
...
{
       0,     3,     4,     8,    13,    15,    21,    22,    23,    24,
      25,    26,     8,    26,    16,    19,    24,     0,    22,     9,
      10,    11,    18,    18,    24,    12,    14,    24,    19,    24,
      24,    24,    17,    24,     5,    22,     6,    22,     7
};
...
#line 146 "sc.y"
						...
						sprintf(t->code, "\tif %s goto %s \n\tgoto %s\n\n%s:%s\n%s:%s\n", (yyvsp[-6].node)->code, temp1, temp2, temp1, (yyvsp[-3].node)->code, temp2, (yyvsp[-1].node)->code);
						(yyval.node) = t;
					}
#line 1479 "y.tab.c"
    break;
...
#line 167 "sc.y"
                                        {	
						Node* lt = (yyvsp[-2].node);
						Node* rt = (yyvsp[0].node);
						Node* t  = get_new_node();	

						if(strlen(lt->line) > 0){
							sprintf(t->code, "%s\n\t%s = %s %s %s", lt->code, t->id, lt->id, (yyvsp[-1].str), rt->code);
							sprintf(t->line, "%s = %s %s %s", t->id, lt->id, (yyvsp[-1].str), rt->code);
							sprintf(t->line, "%s", optimise_code(t->id, lt->id, (yyvsp[-1].str), rt->code, t->line));
							...
							sprintf(t->code, "%s = %s %s %s", t->id, lt->code, (yyvsp[-1].str), rt->code);
							sprintf(t->line, "%s = %s %s %s", t->id, lt->code, (yyvsp[-1].str), rt->code);							
							sprintf(t->line, "%s", optimise_code(t->id, lt->code, (yyvsp[-1].str), rt->code, t->line));
...
#line 228 "sc.y"
						...
						if(strlen(rt->line) > 0){
							sprintf(t->code, "%s\n\t%s = %s", rt->code, (yyvsp[-2].str), rt->id);
						}else{
							sprintf(t->code, "%s = %s", (yyvsp[-2].str), rt->code);
						}
						sprintf(t->line, "%s = %s", (yyvsp[-2].str), rt->id);
